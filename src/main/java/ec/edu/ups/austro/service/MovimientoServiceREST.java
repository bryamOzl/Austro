package ec.edu.ups.austro.service;
...
import ec.edu.ups.austro.negocio.MovimientoONLocal;
...
public class MovimientoServiceREST {
	...
	@GET
	@Produces("application/json")
	@Path("retiroAustro/{numCuenta}/{valor}")
	...
	@GET
	@Produces("application/json")
	@Path("depositoAustro/{numCuenta}/{valor}")
